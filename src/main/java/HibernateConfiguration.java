...
//        em.setPackagesToScan("de.defactox.ruleengine.core.database.persistence.*");
//
...
//        jpaProps.put(Environment.MULTI_TENANT_CONNECTION_PROVIDER, multiTenantConnectionProvider);
//        jpaProps.put(Environment.MULTI_TENANT_IDENTIFIER_RESOLVER, tenantIdentifierResolver);
